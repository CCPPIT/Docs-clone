export const templates=[
    ...
    },
    {
        ...
        <p>Project milestones and delivery schedule.</p>
         <h2>Budget</h2>
         <p>Cost breadown and pyment terms.
    ...
    },
    {
        ...
        <p>Strategy and methodolgy for project execution.</p>
    ...
    },
    {
        ...
        <p>[Company Name]-[Postion] <br>
        [Date Range]
        </p>
         <h2>Education</h2>
        <p>[Dagree]- [Institution] <br>
        [Graduation Year]
        </p>
         <h2>Skills</h2>
         <p>List of relevant and competencies.</p>
    ...
    },
    {
        ...
        <p>[Date]</p>
        <p>[Reciptient's Name] <br>
        [Company Name] <br>
        [Company Address]
        </p>
        <p>I am writing to express my interest in [posttion] at [company name].</p>
        <p>Sinnerely,<br>
        [Your Name]
        </p>
